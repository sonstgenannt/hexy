...
# Source files
SOURCES = src/rect_button.cpp src/entity.cpp src/line.cpp src/circle.cpp src/timer.cpp src/board.cpp src/ai.cpp src/data_manager.cpp src/game_manager.cpp src/main.cpp src/net.cpp
